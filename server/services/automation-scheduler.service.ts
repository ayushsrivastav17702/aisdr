...
class AutomationSchedulerService {
      ...
      try {
        await automationQueue.add(
          'runAutomation',
          {
            ...
            selectedProspectIds: (automationRun.apolloFilters as any)?.selectedProspectIds,
    ...
    for (let attempt = 1; attempt <= maxAttempts; attempt++) {
      try {
        ...
        await automationService.processAutomation(
          ...
          (currentRun.apolloFilters as any)?.selectedProspectIds,
  ...
  async startAutomationLegacy(
    ...
    automationService.processAutomation(
      ...
      (automationRun.apolloFilters as any)?.selectedProspectIds,
  ...
  async rescheduleAutomation(automationRunId: string, newScheduledFor: Date): Promise<void> {
    ...
    await automationQueue.add(
      'runAutomation',
      {
        ...
        selectedProspectIds: (run.apolloFilters as any)?.selectedProspectIds,
